...
/// Soft button with gradient shadow glow.
class NeoButton4 extends StatefulWidget {
  final String label;
  final IconData? icon;
  ...
  @override
  State<NeoButton4> createState() => NeoButton4State();
}

class NeoButton4State extends State<NeoButton4> with SingleTickerProviderStateMixin {
