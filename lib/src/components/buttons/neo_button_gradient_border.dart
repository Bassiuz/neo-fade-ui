...
/// Outlined button with gradient border and glass interior.
///
/// Use via `NeoButton.gradientBorder(...)` for convenient access.
class NeoButtonGradientBorder extends StatefulWidget {
  final String label;
  final IconData? icon;
