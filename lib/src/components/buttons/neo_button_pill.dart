...
///
/// Use via `NeoButton.pill(...)` for convenient access.
class NeoButtonPill extends StatefulWidget {
  final String label;
  final IconData? icon;
  ...
  @override
  State<NeoButtonPill> createState() => NeoButtonPillState();
}

class NeoButtonPillState extends State<NeoButtonPill>
