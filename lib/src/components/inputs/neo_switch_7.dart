...
/// NeoSwitch7 - Glass switch with bouncy thumb animation
///
/// A playful switch with a glass track where the thumb bounces
/// elastically when toggled.
class NeoSwitch7 extends StatefulWidget {
  final bool value;
  ...
  @override
  State<NeoSwitch7> createState() => NeoSwitch7State();
}

class NeoSwitch7State extends State<NeoSwitch7>
  ...
  @override
  void didUpdateWidget(NeoSwitch7 oldWidget) {
