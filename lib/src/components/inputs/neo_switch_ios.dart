...
class NeoSwitchIos extends StatefulWidget {
  ...
  @override
  State<NeoSwitchIos> createState() => NeoSwitchIosState();
}

class NeoSwitchIosState extends State<NeoSwitchIos>
  ...
  @override
  void didUpdateWidget(NeoSwitchIos oldWidget) {
...
class NeoSwitchIosTrackPainter extends CustomPainter {
  final double progress;
  final Color offColor;
  final List<Color> gradientColors;
  final Color borderColor;

  NeoSwitchIosTrackPainter({
  ...
  @override
  bool shouldRepaint(NeoSwitchIosTrackPainter oldDelegate) {
