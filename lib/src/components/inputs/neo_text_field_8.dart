...
import 'corner_gradient_badge_painter.dart';
...
class NeoTextField8 extends StatefulWidget {
  ...
  @override
  State<NeoTextField8> createState() => NeoTextField8State();
}

class NeoTextField8State extends State<NeoTextField8>
                  ...
                  Positioned.fill(
                    child: IgnorePointer(
                      child: ClipRRect(
                        borderRadius: borderRadius,
                        child: CustomPaint(
                          painter: CornerGradientBadgePainter(
                            gradientColors: gradientColors,
                            progress: _badgeAnimation.value,
                            borderRadius: NeoFadeRadii.input,
                            badgeSize: NeoFadeSpacing.md,
                          ),
                        ),
                      ),
                    ),
