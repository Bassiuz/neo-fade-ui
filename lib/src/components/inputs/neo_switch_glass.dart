...
/// NeoSwitchGlass - Glass track with gradient thumb, slides smoothly
///
/// Features a frosted glass track with a vibrant gradient thumb
/// that slides smoothly between on/off positions.
class NeoSwitchGlass extends StatefulWidget {
  final bool value;
  final ValueChanged<bool>? onChanged;
  final bool enabled;

  const NeoSwitchGlass({
    super.key,
    required this.value,
    this.onChanged,
    this.enabled = true,
  ...
  @override
  State<NeoSwitchGlass> createState() => NeoSwitchGlassState();
}

class NeoSwitchGlassState extends State<NeoSwitchGlass>
  ...
  @override
  void didUpdateWidget(NeoSwitchGlass oldWidget) {
