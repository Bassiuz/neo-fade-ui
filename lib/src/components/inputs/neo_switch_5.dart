...
class NeoSwitch5 extends StatefulWidget {
  ...
  @override
  State<NeoSwitch5> createState() => NeoSwitch5State();
}

class NeoSwitch5State extends State<NeoSwitch5>
  ...
  @override
  void didUpdateWidget(NeoSwitch5 oldWidget) {
