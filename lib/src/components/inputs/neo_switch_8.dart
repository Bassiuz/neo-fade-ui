...
class NeoSwitch8 extends StatefulWidget {
  ...
  @override
  State<NeoSwitch8> createState() => NeoSwitch8State();
}

class NeoSwitch8State extends State<NeoSwitch8>
  ...
  @override
  void didUpdateWidget(NeoSwitch8 oldWidget) {
                        ...
                        if (_pulseController.isAnimating ||
                          ...
                          Positioned(
                            ...
                            child: CustomPaint(
                              ...
                              painter: NeoSwitch8PulsePainter(
...
class NeoSwitch8PulsePainter extends CustomPainter {
  final double progress;
  final double opacity;
  final List<Color> gradientColors;

  NeoSwitch8PulsePainter({
  ...
  @override
  bool shouldRepaint(NeoSwitch8PulsePainter oldDelegate) {
