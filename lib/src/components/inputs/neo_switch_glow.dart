...
class NeoSwitchGlow extends StatefulWidget {
  ...
  @override
  State<NeoSwitchGlow> createState() => NeoSwitchGlowState();
}

class NeoSwitchGlowState extends State<NeoSwitchGlow>
  ...
  @override
  void didUpdateWidget(NeoSwitchGlow oldWidget) {
