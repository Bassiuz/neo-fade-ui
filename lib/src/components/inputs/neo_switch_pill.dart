...
/// NeoSwitchPill - Pill switch with gradient track animation on toggle
///
/// A pill-shaped switch where the entire track animates to a vibrant
/// gradient when toggled on.
class NeoSwitchPill extends StatefulWidget {
  final bool value;
  ...
  @override
  State<NeoSwitchPill> createState() => NeoSwitchPillState();
}

class NeoSwitchPillState extends State<NeoSwitchPill>
  ...
  @override
  void didUpdateWidget(NeoSwitchPill oldWidget) {
