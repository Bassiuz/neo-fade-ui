...
/// NeoSwitchRipple - Switch with gradient expanding from thumb on toggle
///
...
class NeoSwitchRipple extends StatefulWidget {
  final bool value;
  final ValueChanged<bool>? onChanged;
  final bool enabled;

  const NeoSwitchRipple({
    super.key,
    required this.value,
    this.onChanged,
    this.enabled = true,
  ...
  @override
  State<NeoSwitchRipple> createState() => NeoSwitchRippleState();
}

class NeoSwitchRippleState extends State<NeoSwitchRipple>
  ...
  @override
  void didUpdateWidget(NeoSwitchRipple oldWidget) {
              ...
              builder: (context, child) {
                ...
                return ClipRRect(
                  ...
                  child: BackdropFilter(
                    ...
                    child: CustomPaint(
                      painter: NeoSwitchRippleTrackPainter(
...
class NeoSwitchRippleTrackPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(NeoSwitchRippleTrackPainter oldDelegate) {
