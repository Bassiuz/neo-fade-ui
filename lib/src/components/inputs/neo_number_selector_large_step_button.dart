...
/// Large step button used in NeoNumberSelectorProminent.
class NeoNumberSelectorLargeStepButton extends StatefulWidget {
  final IconData icon;
  final bool enabled;
  ...
  const NeoNumberSelectorLargeStepButton({
    super.key,
    required this.icon,
  ...
  @override
  State<NeoNumberSelectorLargeStepButton> createState() =>
      NeoNumberSelectorLargeStepButtonState();
}

class NeoNumberSelectorLargeStepButtonState
    extends State<NeoNumberSelectorLargeStepButton>
